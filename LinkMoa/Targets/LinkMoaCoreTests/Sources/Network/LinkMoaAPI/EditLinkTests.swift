...
class EditLinkTests: XCTestCase {
    ...
    // MARK: - testEditLink
    /// 1000 -> 링크 수정 성공
    func testEditLink_whenSucceed() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: 0, params: [
            "linkName": "test",
    ...
    /// 2001 -> 링크 이름을 입력해주세요
    func testEditLink_whenLinkNameIsEmpty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: 0, params: [
            "linkName": "",
    ...
    func testEditLink_whenLinkNameCountOverForty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: 0, params: [
    ...
    func testEditLink_whenLinkURLIsInvalid() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: 0, params: [
            "linkName": "test",
    ...
    func testEditLink_whenImageURLIsInvalid() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: 0, params: [
            "linkName": "test",
    ...
    func testEditLink_whenFaviconURLIsInvalid() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: 0, params: [
            "linkName": "test",
    ...
    /// 2007 인 경우만 test
    func testEditLink_whenFolderIndexIsInvalid() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.editLink(index: -1, params: [
            "linkName": "test",
            "linkUrl": "http://www.naver.com",
            "linkImageUrl": "http://www.naver.com/image",
    ...
    func testEditLink_whenFailure() throws {
        // Given
