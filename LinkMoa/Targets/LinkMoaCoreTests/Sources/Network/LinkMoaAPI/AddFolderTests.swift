...
class AddFolderTests: XCTestCase {
    ...
    // MARK: - testAddFolder
    /// 1000 -> 폴더 생성 성공
    func testAddFolder_whenSucceed_withPrivateFolderType() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
            "folderType": "private"
        ])
    ...
    /// 1000 -> 폴더 생성 성공
    func testAddFolder_whenSucceed_withPublicFolderType() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenFolderNameIsEmpty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "",
    ...
    func testAddFolder_whenFolderNameIsBiggerThanThirty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
    ...
    func testAddFolder_whenTagNameCountIsBiggerThanTwenty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenFolderTypeIsEmpty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenFolderTypeIsInvalid() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenCategoryIdxIsEmpty_withPublicFolderType() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenCategoryIdxIsBiggerThanFive() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenDetailCategoryIdxIsEmpty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenDetailCategoryIdxIsBiggerThanThirty() throws {
        // Given
        let promise = XCTestExpectation(description: "Subscribe is executed")
        let api = LinkMoaAPI.addFolder(params: [
            "folderName": "test",
    ...
    func testAddFolder_whenFailure() throws {
        // Given
