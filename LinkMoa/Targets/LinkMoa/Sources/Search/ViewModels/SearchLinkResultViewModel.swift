//
//  SearchLinkResultViewModel.swift
//  LinkMoa
//
...
final class SearchLinkResultViewModel: ViewModelType {
    struct Input {
    ...
    struct Output {
        var results: Driver<[SearchLink.Result]>
        var count: Driver<Int>
        var errorMessage: Signal<String>
    }

    private let results = BehaviorRelay<[SearchLink.Result]>(value: [])
